...
describe('QrFormatter', () => {
  ...
  test('should format location data correctly', () => {
  ...
  test('should format wifi data with password correctly', () => {
  ...
  test('should format wifi data without password correctly', () => {
    const wifiData: WifiData = { 
      ssid: 'OpenNetwork', 
      encryption: 'nopass', 
      password: '' 
  ...
  test('should format business card data correctly', () => {
